...
const productData: any = {
  ...
  {name:"Printed Tapes",img:"/custom/printed.png"},
  {name:"Shiny Niwar Tapes",img:"/custom/shiny.png"},
  {name:"Belts",img:"/custom/belts.png"},
  ],
  
  shoelaces:[
  {name:"Polyester Laces",img:"/shoelaces/image.png"},
  {name:"Elasticated Laces",img:"/shoelaces/image copy.png"},
  {name:"Waxy Laces",img:"/shoelaces/image copy 2.png"},
  {name:"Round Elastic Laces",img:"/shoelaces/image copy 3.png"},
  {name:"Round Laces",img:"/shoelaces/image copy 4.png"},
  {name:"Flat Laces",img:"/shoelaces/image copy 5.png"},
  {name:"Shiny Laces",img:"/shoelaces/image copy 6.png"},
  {name:"Dot Laces",img:"/shoelaces/image copy 7.png"},
  {name:"Organza Laces",img:"/shoelaces/image copy 8.png"},
  {name:"Satin Laces",img:"/shoelaces/image copy 9.png"},
  ],
  
  custom:[
  {name:"Jacquard Tapes",img:"/custom3/image.png"},
  {name:"Monofilament Elastic",img:"/custom3/image copy.png"},
  {name:"Surgical Elastic",img:"/custom3/image copy 2.png"},
  {name:"Exercise Belts",img:"/custom3/image copy 3.png"},
  {name:"Designed Elastics",img:"/custom3/image copy 4.png"},
  ],
  
  elasticcords:[
  {name:"Round Cords",img:"/custom2/image.png"},
  {name:"Cotton Cords",img:"/custom2/image copy.png"},
  {name:"Braided Belts",img:"/custom2/image copy 2.png"},
  {name:"Flat Braid Elastic",img:"/custom2/image copy 3.png"},
  {name:"Dot Elastic",img:"/custom2/image copy 4.png"},
  ]
